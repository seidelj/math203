...
If $0 < p < 1$, case we have $n^{-p} < \epsilon$. This not possible, because $n \in \mathbb{N}$.

Similarly, if $p < 0$ then we have to satisfy $n^p < \epsilon$ which is also not possible.
